...
public class ScormPackageExporter {
    ...
    public ScormPackageExporter() {
        this.manifestGenerator = new ScormManifestGenerator();
        this.htmlGenerator = new HtmlContentGenerator();
    }
    
    public void exportPackage(Quiz quiz, File outputFile) throws IOException {
        try (FileOutputStream fos = new FileOutputStream(outputFile);
            ...
            // Add manifest file
            addManifestToZip(zos, quiz);
            
            // Add HTML content
            addHtmlContentToZip(zos, quiz);
    ...
    private void addManifestToZip(ZipArchiveOutputStream zos, Quiz quiz) throws IOException {
        String manifestContent = manifestGenerator.generateManifest(quiz);
    ...
    private void addHtmlContentToZip(ZipArchiveOutputStream zos, Quiz quiz) throws IOException {
        String htmlContent = htmlGenerator.generateIndexHtml(quiz);
    ...
    private void addResourceFileToZip(ZipArchiveOutputStream zos, String resourcePath, String zipEntryName) throws IOException {
    ...
    public String generatePackageName(Quiz quiz) {
        String safeName = quiz.getTitle()
