        ...
        public String generateIndexHtml(ScormPackage scormPackage) {
                ...
                if (scormPackage.getDescription() != null && !scormPackage.getDescription().trim().isEmpty()) {
                        html.append("            <p class=\"description\">")
                                        .append(escapeHtml(scormPackage.getDescription()))
                                        .append("</p>\n");
                }
                html.append("        </header>\n");
                html.append("        \n");
                ...
                // Add welcome video if URL exists
                if (scormPackage.getWelcomeVideoUrl() != null && !scormPackage.getWelcomeVideoUrl().isEmpty()) {
                        html.append("                <div class=\"welcome-video-container\">\n");
                        html.append("                    <iframe src=\"").append(scormPackage.getWelcomeVideoUrl())
                                        .append("\" title=\"Welcome Video\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture\" allowfullscreen></iframe>\n");
                        html.append("                </div>\n");
                }
                ...
                html.append("                <button id=\"review-btn\" class=\"btn btn-secondary\" style=\"display: none;\">Xem lại</button>\n");

                html.append("            <div id=\"review-screen\" class=\"screen\">\n");
                html.append("                <h2>Xem lại bài làm</h2>\n");
                html.append("                <div id=\"review-container\"></div>\n");
                html.append("                <button id=\"back-to-results-btn\" class=\"btn btn-primary\">Quay lại</button>\n");
                html.append("            </div>\n");
                html.append("            </div>\n");
                html.append("        </div>\n");
                html.append("    </div>\n");
                ...
                html.append("            initializeQuiz(").append(generateQuizDataJson(scormPackage)).append(");\n");
                html.append("        });\n");
                html.append("    </script>\n");
                html.append("</body>\n");
                html.append("</html>");
        ...
        private String generateQuizDataJson(ScormPackage scormPackage) {
                ...
                json.append("    \"description\": \"")
                                .append(escapeJson(scormPackage.getDescription() != null ? scormPackage.getDescription()
                                                : ""))
                                .append("\",\n");
                json.append("    \"welcomeVideoUrl\": \"")
                                .append(escapeJson(scormPackage.getWelcomeVideoUrl() != null
                                                ? scormPackage.getWelcomeVideoUrl()
                                                : ""))
                                .append("\",\n");
                json.append("    \"theme\": ")
                                .append(scormPackage.getThemeJson() != null && !scormPackage.getThemeJson().isEmpty()
                                                ? scormPackage.getThemeJson()
                                                : "{}")
                                .append(",\n");
                ...
                json.append("    \"reviewMode\": \"").append(scormPackage.getReviewMode()).append("\",\n");
                ...
                if (scormPackage.getQuestions() != null) {
                        for (int i = 0; i < scormPackage.getQuestions().size(); i++) {
                                ...
                                json.append("            \"text\": \"").append(escapeJson(question.getText()))
                                                .append("\",\n");
                                json.append("            \"questionType\": \"").append(question.getQuestionType())
                                                .append("\",\n");
                                ...
                                if (question.getAnswers() != null) {
                                        for (int j = 0; j < question.getAnswers().size(); j++) {
                                                ...
                                                json.append("                {\n");
                                                json.append("                    \"id\": \"").append(answer.getId())
                                                                .append("\",\n");
                                                json.append("                    \"text\": \"")
                                                                .append(escapeJson(answer.getText()))
                                                                .append("\",\n");
                                                json.append("                    \"imageUrl\": \"")
                                                                .append(escapeJson(answer.getImageUrl() != null
                                                                                ? answer.getImageUrl()
                                                                                : ""))
                                                                .append("\",\n");
                                                json.append("                    \"correct\": ")
                                                                .append(answer.getCorrect()).append(",\n");
                                                json.append("                    \"matchValue\": \"")
                                                                .append(escapeJson(answer.getMatchValue() != null
                                                                                ? answer.getMatchValue()
                                                                                : ""))
                                                                .append("\"\n");
                                                json.append("                }");
